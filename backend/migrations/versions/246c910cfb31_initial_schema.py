...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_leagues_api_football_id"), "leagues", ["api_football_id"], unique=True
    )
    op.create_table(
        "teams",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_teams_api_football_id"), "teams", ["api_football_id"], unique=True
    )
    op.create_table(
        "users",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "ix_fixture_kickoff_league", "fixtures", ["kickoff", "league_id"], unique=False
    )
    op.create_index(
        op.f("ix_fixtures_api_football_id"),
        "fixtures",
        ["api_football_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_fixtures_league_id"), "fixtures", ["league_id"], unique=False
    )
    op.create_table(
        "standings",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_standings_league_id"), "standings", ["league_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_odds_fixture_bookmaker", "odds", ["fixture_id", "bookmaker"], unique=False
    )
    ...
    op.create_index(
        "ix_prediction_view_user_week",
        "prediction_views",
        ["user_id", "viewed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_prediction_views_user_id"),
        "prediction_views",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_predictions_fixture_id"), "predictions", ["fixture_id"], unique=False
    )
    op.create_table(
        "sentiment_scores",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_sentiment_scores_fixture_id"),
        "sentiment_scores",
        ["fixture_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sentiment_scores_team_id"),
        "sentiment_scores",
        ["team_id"],
        unique=False,
    )
