...
const translations: Record<Locale, Record<string, string>> = {
    sv: {
        ...
        "vm.title": "VM 2026",
        "vm.subtitle": "Hela turneringen — grupper, slutspel, AI-analys",
        "vm.host": "USA · Kanada · Mexico",
        "vm.kickoff": "Sparkar igång 11 juni",
        "vm.groups": "Gruppspel",
        "vm.knockouts": "Slutspel",
        "vm.sverige_title": "Sverige saknas — vi följer ändå",
        "vm.sverige_body": "Sverige kvalade inte in. Vi följer Norge (deras första VM på 26 år, med Haaland som drag-lok), Danmarks gruppspel och svenska spelare i andra landslag. Allsvenskan rullar parallellt — vi täcker bägge.",
        "vm.sverige_cta": "Till Allsvenskan",
    ...
    en: {
        ...
        "nav.login": "Sign in",
        "nav.signup": "Sign up",
        "vm.title": "World Cup 2026",
        "vm.subtitle": "The full tournament — groups, knockouts, AI analysis",
        "vm.host": "USA · Canada · Mexico",
        "vm.kickoff": "Kicks off June 11",
        "vm.groups": "Group stage",
        "vm.knockouts": "Knockouts",
        "vm.sverige_title": "Sweden's not in — we follow it anyway",
        "vm.sverige_body": "Sweden didn't qualify. We're following Norway (their first World Cup in 26 years, with Haaland as the centerpiece), Denmark's group and Swedish players on other national teams. Allsvenskan continues alongside — we cover both.",
        "vm.sverige_cta": "Go to Allsvenskan",
